  ...
  return <section id="servicos" className="py-4 lg:py-6 bg-background relative overflow-hidden scroll-mt-16">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-text-secondary max-w-3xl mx-auto text-xl font-medium text-blue-100">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="group p-6 bg-card rounded-xl border border-border hover:border-primary/50 transition-all duration-300 hover:transform hover:scale-105">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2 transition-colors text-[#68d7ff]">
                    {service.title}
                  </h3>
