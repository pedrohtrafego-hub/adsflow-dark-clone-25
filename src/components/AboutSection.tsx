...
const AboutSection = () => {
  return <section id="sobre" className="py-4 pb-2 bg-background scroll-mt-16 lg:py-[24px]">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 lg:gap-8 max-w-6xl pt-2 my-0 px-0 py-0 mx-[110px]">
