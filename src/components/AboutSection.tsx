        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-text-secondary leading-relaxed mb-8 mx-0 px-0 my-px text-zinc-50 text-left">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden border border-border">
              <img src={teamMeeting} alt="Equipe Ads Flow em reunião estratégica" className="w-full h-full object-cover" />
            </div>
